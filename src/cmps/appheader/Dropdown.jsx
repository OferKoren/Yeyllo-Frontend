...
export function Dropdown({ title = 'dropdown', setIsModalOpen }) {
    ...
    const [star, setStar] = useState('full')
        ...
        <div className="dropdown">
            ...
            <ul className="dropdown-list">
                {boards.map((board) => {
                    ...
                    return (
                        <li key={board._id} onClick={() => toBoard(board._id)} className="dropdown-item">
                            <div className="item-content">
                                <div className="img" style={board.style}></div>
    ...
    function StarFull() {
        return (
            <svg width="18px" height="18px" viewBox="0 0 24 24" fill="#e2b203" xmlns="http://www.w3.org/2000/svg">
                <path
