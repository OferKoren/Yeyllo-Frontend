        ...
        <>
            {
                group.isCollapse
                    ?
                    <article className={`group-preview collapse`} style={{/*padding:'0', width:'max-content', height:'100%'*/}}>
                        <header style={{display:'flex', flexDirection:'column', }} className="group-header">
                            ...
                            <div onClick={onCollapse} className={`group-header-btn ${group?.style?.backgroundColor?.substr(1)}`}>{title}</div>
                        </header>
                    </article>
                    :
