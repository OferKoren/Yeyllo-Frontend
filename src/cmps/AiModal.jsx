...
export function AiModal({ onCloseModal, onOpenModal }) {
    ...
    useEffect(() => {
        ...
        }, 500); // Adjust speed as needed (500ms per step)
    ...
    useEffect(() => {
        if (dotsRef.current) {
            dotsRef.current.textContent = dots; // Update DOM manually via ref
        }
    }, [dots])
            ...
            {!isLoading ?
                <>
                    <div className="ai-modal-header">
                        <svg className="ai-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 318.2022471910112 323.33333333333337" style={{ maxHeight: '500px', fill: 'currentcolor' }}>
                            ...
                            <path d="m823.98 240h28.8v-73.92c0-18 13.2-27.6 26.16-27.6 15.84 0 22.08 11.28 22.08 26.88v74.64h28.8v-83.04c0-27.12-15.84-45.36-42.24-45.36-16.32 0-27.6 7.44-34.8 15.84v-13.44h-28.8z" /><path d="m1014.17 67.68-65.28 172.32h30.48l14.64-39.36h74.4l14.88 39.36h30.96l-65.28-172.32zm16.8 34.08 27.36 72h-54.24z" /><path d="m1163.69 68.18h-30.72v172.32h30.72z" />
                    ...
                    <form onSubmit={onGenerateAiBoard}>
                        <label htmlFor="topic">Start with a topic, any idea works!</label>
