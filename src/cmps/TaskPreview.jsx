...
export function TaskPreview({
    ...
    function getDateColor(date) {
        ...
        if (today.getDate() === date.getDate() || (today.getDate() - 1 === date.getDate() && today.getMonth() === date.getMonth()))
            return { backgroundColor: '#c9372c', color: 'white', title: 'This card is recently overdue!' }
        ...
        if (date >= today && date <= today.setTime(today.getTime() + 24 * 60 * 60 * 1000))
            return { backgroundColor: '#f5cd47', color: '#172b4d', title: 'This card is due in less than twenty-four hours.' }
    ...
    async function onDateClick(e) {
        ...
        try {
            isDone
                ? (board.groups[currGroupIdx].tasks[currTaskIdx].status = 'inProgress')
