...
export function TaskPreview({ onUpdateBoard, board, isLabelsClicked, setIsLabelsClicked, groupId, task, index }) {
    ...
    return (
        <>
            <Draggable index={index} draggableId={task.id} >
                {(provided) => (
                <article onClick={onOpenModal} className="task-preview" {...provided.dragHandleProps} {...provided.draggableProps} ref={provided.innerRef}>
