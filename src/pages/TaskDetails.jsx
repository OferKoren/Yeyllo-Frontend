                            ...
                            >
                                <svg width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        ...
                                        style={{ fill: openModal === 'labels' ? '#ffffff' : '#333333' }}
                                    />
                                </svg>
                                <span>Labels</span>
                            </button>
                            ...
                            >
                                <svg width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        ...
                                        style={{ fill: openModal === 'checklist' ? '#ffffff' : '#333333' }}
                                    />
                                </svg>
                                <span> Checklist</span>
                            </button>
                            ...
                            >
                                <svg width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        ...
                                        clipRule="evenodd"
                                        d="M5 5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V7C21 5.89543 20.1046 5 19 5H5ZM19 7H5V13H19V7Z"
                                        style={{ fill: openModal === 'cover' ? '#ffffff' : '#333333' }}
                                    />
                                </svg>
                                <span>Cover</span>
                            </button>
                            ...
                            >
                                <svg width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        ...
                                        style={{ fill: openModal === 'attachment' ? '#ffffff' : '#333333' }}
                                    />
                                </svg>
